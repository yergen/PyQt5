...
import requests
def get_one_page_data(key, date_start='', date_end='', fulltext_str_flag='false', page_num=1, \
                                    pageSize=30, sortName='nothing', sortType='desc'):
    '''
    :param key:搜索的关键词
    :param date_start:起始时间
    :param date_end:终止时间
    :param fulltext_str_flag:是否内容搜索，默认为false，即标题搜索
    ...
    headers = {'Accept':'application/json,text/javascript,*/*;q=0.01', 
                    ...
                    'Referer':'http://www.cninfo.com.cn/cninfo-new/fulltextSearch\
                    ?code=&notautosubmit=&keyWord=%s' %key_encode, 
                    'User-Agent':'Mozilla/5.0(window NT 10.0;Win64;x64)AppleWebKit/\
                    537.36(KHTML,like Gecko)Chrome/51.0.2704.63 Safari/537.36Qiyu/2.1.0.0', \
...
if __name__ == '__main__':
    total_num, page_value=get_one_page_data('中国中车', \
    date_start='2015-01-05', date_end='2015-07-03')
