...
def createTabelAndInit():
    ...
    query.exec("create table student(id int primary key,\
            name vchar,sex vchar,age int,department vchar)")
...
class DataGrid(QWidget):
    ...
    def setTotalRecordLabel(self):
        ...
        print('***setTotalPageLabel szTotalRecordText=' +szTotalRecordText + '***')
